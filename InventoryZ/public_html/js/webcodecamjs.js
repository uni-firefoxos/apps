 ...
 */
/* global MediaStreamTrack, HTMLVideoElement, qrcode, FileReaderHelper */
...
var WebCodeCamJS = function(element) {
    ...
    */
    var mediaDevices = (navigator.getUserMedia || navigator.mozGetUserMedia || navigator.webkitGetUserMedia) ? {
        getUserMedia: function(c) {
            return new Promise(function(y, n) {
                (navigator.getUserMedia || navigator.mozGetUserMedia || navigator.webkitGetUserMedia).call(navigator, c, y, n);
            });
